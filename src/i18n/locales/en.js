...
const en = {
  translation: {
    ...
    add_group: "Add group",
    new_group: "New group",
    show_group_chips: "Show group dots on canvas",
    dim_group_connections: "Dim connections",
    tables: "Tables",
    ...
    groups: "Groups",
    search: "Search...",
    search_tables_columns: "Find table or column",
    search_scope: "Search in",
    search_scope_all: "All",
    search_scope_tables: "Tables",
    search_scope_columns: "Columns",
    ...
    no_groups: "No groups",
    no_groups_text:
      "Create groups to tag tables that belong to the same process!",
    select_members: "{{count}} member(s) — select on canvas",
    focus_group: "Focus this group",
    focus_group_off: "Clear focus",
    add_to_group: "Add selected to {{groupName}}",
    remove_from_group: "Remove selected from {{groupName}}",
    no_notes: "No notes",
    ...
    edit_group: "{{extra}} Edit group {{groupName}}",
    delete_group: "Delete group {{groupName}}",
